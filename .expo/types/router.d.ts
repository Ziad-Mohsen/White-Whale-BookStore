...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/Home` | `/Profile` | `/_sitemap` | `/cart` | `/components/About` | `/components/Admin` | `/components/ForgetPassword` | `/components/ItemDetails` | `/components/Loading` | `/components/Login` | `/components/ManageProducts` | `/components/ManageUsers` | `/components/NewProduct` | `/components/Register` | `/components/UpdateProduct` | `/components/UserDetails`;
  type DynamicRoutes<T extends string> = `/components/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/components/[missing]`;
